...
The previous atatcks ar enot possible with *DNSSec*, that implements secure DNS with authentication and integrity (confidentiality is not required) checks with a public-key infrastructure.
